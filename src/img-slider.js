...
const slider = () => {
  ...
  imgWindows.appendChild(buildElement("div", "img-holder", "", ""));
  main.appendChild(
    buildElement(
      "button",
      "scroll-forward",
  ...
  const loadImages = () => {
    ...
    imgHolder.appendChild(buildElement("div", "image1", ["image-container"]));
    document.getElementById("image1").appendChild(image1);

    let image2 = new Image();
    image2.src = lloyd;
    image2.classList.add("images");
    imgHolder.appendChild(buildElement("div", "image2", ["image-container"]));
    document.getElementById("image2").appendChild(image2);

    let image3 = new Image();
    image3.src = zoe;
    image3.classList.add("images");
    imgHolder.appendChild(buildElement("div", "image3", ["image-container"]));
